...
// RCC->AHBENR |= (1<<19); //C PORT ACTİVE
// RCC->AHBENR |= (1<<17); //A PORT ACTİVE

 //OUTPUT CONFİGURATİON :::
...
//GPIOC->OTYPER &= ~(1<<8); //PUSH PULL OUTPUT
//GPIOC->OTYPER &= ~(1<<9); //PUSH PULL OUTPUT
